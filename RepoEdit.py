...
def process_repository(repo, excluded_repos, namespace_to_match, repos_to_change, file_exclusions, str_to_replace,
                       replacement_string, change_repo_name):
...
def main():
    ...
    if not repos_to_change:
        ...
        for repo in g.get_user().get_repos(type="owner"):
            process_repository(repo, excluded_repos, namespace_to_match, repos_to_change, file_exclusions,
                               str_to_replace, replacement_string, change_repo_name)
    else:
